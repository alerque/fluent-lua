   ...
   describe("messages", function ()
      ...
      it("can be accessed as properties", function ()
         ...
         assert.error(function ()
            return bundle.apple:format()
         end)
         assert.error(function ()
            return en.apple:format()
         end)
         assert.error(function ()
            return bundle["apple"]:format()
         end)
      ...
      it("preserves attributes when messages are added", function ()
         ...
         assert.error(function ()
            return bundle:get_message("bar"):get_attribute("bax")()
         end)
         assert.error(function ()
            return en:get_message("bar"):get_attribute("bax")()
         end)
         assert.error(function ()
            return bundle.bar.bax()
         end)
         assert.error(function ()
            return en.bar.bax()
         end)
