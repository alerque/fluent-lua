...
local ftl_grammar = epnf.define(function (_ENV)
  ...
  SelectExpression = (V"StringLiteral" + V"NumberLiteral" + V"FunctionReference" + (P"-" * V"Identifier" * V"AttributeAccessor" * V"CallArguments"^-1) + V"VariableReference" + inline_placeable) * blank^-1 * P"->" * blank_inline^-1 * V"variant_list"
