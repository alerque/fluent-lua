...
local ftl_grammar = epnf.define(function (_ENV)
  ...
  local _inline_placeable = P"{" * blank^-1 * V"_InlineExpression" * blank^-1 * P"}"
  ...
  _InlineExpression = V"StringLiteral" + V"NumberLiteral" + V"FunctionReference" + V"_TermReference" + V"VariableReference" + _inline_placeable
